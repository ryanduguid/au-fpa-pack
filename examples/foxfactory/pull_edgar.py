...
def write_sources() -> None:
    lines = [
        ...
        "segment Adjusted EBITDA (US$225.7M) and consolidated Adjusted EBITDA (US$168.4M). The",
        "Phase B holdout scores consolidated Adjusted EBITDA with the same reconciliation's",
        "FY2023 and FY2024 figures (US$62.661M and US$56.362M): each candidate carries FY2024",
        "corporate expense forward, and the FY2025 actual deducts US$57.338M.",
        "",
